...
<div class="row">
    <div class="col-lg-12">
        <x-card>
            <x-slot name="header">
                <button onclick="addForm(`{{ route('campaign.store') }}`)" class="btn btn-primary"><i class="fas fa-plus-circle"></i>Tambah</button href="{{ route('category.create') }}">
            </x-slot>
...
@push('scripts')
    <script>
        ...
        function resetForm(selector) {
            ...
            $('.form-control, .custom-select, .custom-checkbox, .custom-radio, .select2, .note_editor').removeClass('is-invalid');
